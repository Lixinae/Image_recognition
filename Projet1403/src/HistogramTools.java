...
public class HistogramTools {
	 ...
	 * @throws IOException 
	 */
	public static void plotHistogram(double [] histogram,String t) throws IOException{
        ...
        JFreeChart jfreechart = ChartFactory.createXYBarChart("Histogramme de l'image",t, false, "Nombre de pixels", myseriescollection, PlotOrientation.VERTICAL, true, false, false);   
